...
val surfaceContainerLowLight = Color(0xFFF0F5F6)
val surfaceContainerLight = Color(0xFFEAF0F0)
...
val secondaryContainerDark = Color(0xFF334A4F)
...
// Zone Accents (Fixed colors, distinguishable in light/dark)
val ZoneAccent1 = Color(0xFFE91E63) // Pink
val ZoneAccent2 = Color(0xFF9C27B0) // Purple
val ZoneAccent3 = Color(0xFF2196F3) // Blue
val ZoneAccent4 = Color(0xFF4CAF50) // Green
val ZoneAccent5 = Color(0xFFFFEB3B) // Yellow
val ZoneAccent6 = Color(0xFFFF9800) // Orange
